...
export function createQuestionElement(
  ...
  questionElement.innerHTML = `
    ...
    <div class="grow p-4">
      <a id="${question.id}" href="/questions/1/how-to-loop-thourgh-an-array-in-javascript/how-to-loop-through-an-array-in-javascript.html?id=${question.id}" class="mb-1.5 text-2xl hover:text-sky-500">
        ${question.title}
      </a>
